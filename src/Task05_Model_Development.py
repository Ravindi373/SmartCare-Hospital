...
def run_task05():
    ...
    if not (x_train_path.exists() and y_train_path.exists()):
        print("Prepared datasets not found. Running Task 03 to generate them...")
    ...
    # -------------------------------------------------------------
    # 3. Comparative Evaluation on Held-Out Test Set
    # -------------------------------------------------------------
    ...
    # -------------------------------------------------------------
    # 4. Serialize Model Artifacts & Unified Pipeline Bundle
    # -------------------------------------------------------------
    ...
    if feature_artifacts_path.exists():
        ...
        raw_path = BASE_DIR / "data" / "raw" / "smartcare_ai_dataset_1000.csv"
        _, _, pipeline_bundle = fit_feature_pipeline(load_and_clean_data(raw_path), k=15)
